            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Menna</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">Panorama Club, 6th of October</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      <section id="countdown" className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-b from-background to-accent/5">
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <CountdownTimer targetDate={new Date("2026-03-27T19:00:00")} />
          </motion.div>
        </motion.div>
      </section>
